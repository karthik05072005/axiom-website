...
export function generateChecklistPDF(selectedLicenses, licenseDocuments) {
  ...
  doc.setProperties({
    title: "AXIOM360 AI License Document Checklist",
    subject: "Required Documents for Medical Licenses",
    author: "AXIOM360 AI Compliance Assistant",
  ...
  doc.text("AXIOM360 AI License Document Checklist", margin, yPosition);
  yPosition += 15;

  // Add subtitle
  doc.setFontSize(12);
  doc.setFont("helvetica", "normal");
  doc.text("Generated by AXIOM360 AI Compliance Assistant", margin, yPosition);
  yPosition += 5;
  ...
  // Save the PDF
  doc.save("AXIOM360 AI-Document-Checklist.pdf");
}